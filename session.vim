...
badd +91 DataUtil.cs
badd +1 WordHash.as
badd +1 \archive\python\as2cs\test\TestSyntaxModel.as
...
badd +1 \archive\python\as2cs\README.md
...
badd +140 UnityToykit\Toolkit\Progress.cs
...
silent! normal! zE
let s:l = 75 - ((10 * winheight(0) + 10) / 20)
...
exe '3resize ' . ((&lines * 10 + 16) / 33)
exe 'vert 3resize ' . ((&columns * 64 + 66) / 133)
tabedit C:\archive\unity\anagram\Assets\Scripts\Metrics.cs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
7argu
edit C:\archive\unity\anagram\Assets\Scripts\Metrics.cs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((17 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 193 - ((7 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((17 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 300 - ((17 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
300
